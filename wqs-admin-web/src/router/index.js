...
// 设置标题
// document.title = sysBaseConfig.WQS_SYS_NAME
...
router.beforeEach(async (to, from, next) => {
	...
	const sysBaseConfig = tool.data.get('WQS_SYS_BASE_CONFIG') || store.sysBaseConfig
	// 动态标题
	document.title = to.meta.title
		? `${to.meta.title} - ${sysBaseConfig.WQS_SYS_NAME}`
		: `${sysBaseConfig.WQS_SYS_NAME}`
