		...
		>
			<header id="snowyHeaderLogo" class="snowy-header-logo">
				<div class="snowy-header-left">
					<div class="logo-bar">
						<img class="logo" :src="sysBaseConfig.WQS_SYS_LOGO" />
						<span>{{ sysBaseConfig.WQS_SYS_NAME }}</span>
					</div>
				</div>
			</header>
			...
			>
				<div id="admin-ui-main" class="admin-ui-main">
					...
					<div v-if="footerCopyrightOpen" class="main-bottom-wrapper">
						<a class="xn-color-a0a0a0" :href="sysBaseConfig.WQS_SYS_COPYRIGHT_URL" target="_blank">{{
							sysBaseConfig.WQS_SYS_COPYRIGHT
						}}</a>
					</div>
				</div>
			</a-layout-content>
