		...
		configApi
			...
			.then((data) => {
				if (data) {
					...
					phoneLogin.value = formData.value.WQS_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_B
					emailLogin.value = formData.value.WQS_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_B
