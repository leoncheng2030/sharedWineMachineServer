<script setup>
	...
	const captchaOpen = ref(configData.SYS_BASE_CONFIG.WQS_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_B)
		...
		configApi
			...
			.then((data) => {
				...
				if (data) {
					...
					captchaOpen.value = formData.value.WQS_SYS_DEFAULT_CAPTCHA_OPEN_FLAG_FOR_B
					registerOpen.value = formData.value.WQS_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_B
	...
	<div class="login-wrapper">
		<div class="login_background">
			<div class="logo_background">
				<a
					:class="{ 'no-link': !sysBaseConfig.WQS_SYS_COPYRIGHT_URL }"
					:href="sysBaseConfig.WQS_SYS_COPYRIGHT_URL"
					target="_blank"
					@click="handleLink"
				>
					<img :alt="sysBaseConfig.WQS_SYS_NAME" :src="sysBaseConfig.WQS_SYS_LOGO" />
					<label>{{ sysBaseConfig.WQS_SYS_NAME }}</label>
				</a>
			</div>
			<div class="version">
