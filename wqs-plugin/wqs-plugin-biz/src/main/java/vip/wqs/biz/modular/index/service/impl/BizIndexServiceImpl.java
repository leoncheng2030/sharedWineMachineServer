 ...
 */
package vip.wqs.biz.modular.index.service.impl;
...
import vip.wqs.biz.modular.index.param.BizIndexNoticeIdParam;
import vip.wqs.biz.modular.index.param.BizIndexNoticeListParam;
import vip.wqs.biz.modular.index.param.BizIndexSlideshowListParam;
import vip.wqs.biz.modular.index.result.BizIndexNoticeListResult;
import vip.wqs.biz.modular.index.result.BizIndexSlideshowDetailResult;
import vip.wqs.biz.modular.index.result.BizIndexSlideshowListResult;
import vip.wqs.biz.modular.index.service.BizIndexService;
import vip.wqs.biz.modular.notice.entity.BizNotice;
import vip.wqs.biz.modular.notice.enums.BizNoticeStatusEnum;
import vip.wqs.biz.modular.notice.service.BizNoticeService;
...
public class BizIndexServiceImpl implements BizIndexService {
    ...
    public List<BizIndexSlideshowListResult> slideshowListByPlace(BizIndexSlideshowListParam bizIndexSlideshowListParam) {
        return devSlideshowApi.getListByPlace(bizIndexSlideshowListParam.getPlace()).stream()
                .map(devSlideshowPojo -> BeanUtil.toBean(devSlideshowPojo, BizIndexSlideshowListResult.class)).collect(Collectors.toList());
    }
