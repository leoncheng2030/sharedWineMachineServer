 ...
 */
package vip.wqs.biz.modular.user.service.impl;
...
import vip.wqs.biz.core.enums.BizBuildInEnum;
import vip.wqs.biz.core.enums.BizDataTypeEnum;
import vip.wqs.biz.modular.org.entity.BizOrg;
import vip.wqs.biz.modular.org.service.BizOrgService;
import vip.wqs.biz.modular.position.entity.BizPosition;
import vip.wqs.biz.modular.position.service.BizPositionService;
import vip.wqs.biz.modular.user.entity.BizUser;
import vip.wqs.biz.modular.user.entity.BizUserExt;
import vip.wqs.biz.modular.user.enums.BizRoleCategoryEnum;
import vip.wqs.biz.modular.user.enums.BizUserStatusEnum;
import vip.wqs.biz.modular.user.mapper.BizUserMapper;
import vip.wqs.biz.modular.user.param.*;
import vip.wqs.biz.modular.user.result.BizUserExportResult;
import vip.wqs.biz.modular.user.result.BizUserRoleResult;
import vip.wqs.biz.modular.user.service.BizUserExtService;
import vip.wqs.biz.modular.user.service.BizUserService;
...
import vip.wqs.sys.api.SysRoleApi;
import vip.wqs.sys.api.SysUserApi;
