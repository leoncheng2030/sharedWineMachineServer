...
public class DevEmailTencentUtil {
    ...
    private static final String WQS_EMAIL_TENCENT_SECRET_ID_KEY = "WQS_EMAIL_TENCENT_SECRET_ID";
    private static final String WQS_EMAIL_TENCENT_SECRET_KEY_KEY = "WQS_EMAIL_TENCENT_SECRET_KEY";
    private static final String WQS_EMAIL_TENCENT_FROM_KEY = "WQS_EMAIL_TENCENT_FROM";
    ...
    private static void initClient() {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(WQS_EMAIL_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(WQS_EMAIL_TENCENT_SECRET_KEY_KEY);
    ...
    public static String getDefaultFrom() {
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        String signName = devConfigApi.getValueByKey(WQS_EMAIL_TENCENT_FROM_KEY);
