 ...
 */
package vip.wqs.dev.modular.file.util;
...
import vip.wqs.dev.modular.file.enums.DevFileBucketAuthEnum;
...
public class DevFileMinIoUtil {
    ...
    private static final String WQS_FILE_MINIO_ACCESS_KEY_KEY = "WQS_FILE_MINIO_ACCESS_KEY";
    private static final String WQS_FILE_MINIO_SECRET_KEY_KEY = "WQS_FILE_MINIO_SECRET_KEY";
    private static final String WQS_FILE_MINIO_END_POINT_KEY = "WQS_FILE_MINIO_END_POINT";
    private static final String WQS_FILE_MINIO_DEFAULT_BUCKET_NAME = "WQS_FILE_MINIO_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* accessKey */
        String accessKey = devConfigApi.getValueByKey(WQS_FILE_MINIO_ACCESS_KEY_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(WQS_FILE_MINIO_SECRET_KEY_KEY);
        ...
        /* endpoint */
        String endpoint = devConfigApi.getValueByKey(WQS_FILE_MINIO_END_POINT_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(WQS_FILE_MINIO_DEFAULT_BUCKET_NAME);
    ...
    public static String getFileAuthUrl(String bucketName, String key) {
        try {
            initClient();
            DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
            return devConfigApi.getValueByKey(WQS_FILE_MINIO_END_POINT_KEY) + StrUtil.SLASH + bucketName + StrUtil.SLASH + key;
        } catch (Exception e) {
            throw new CommonException(e.getMessage());
        }
    }
