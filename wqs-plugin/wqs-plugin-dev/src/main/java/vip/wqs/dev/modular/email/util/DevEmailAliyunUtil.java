...
public class DevEmailAliyunUtil {
    ...
    private static final String WQS_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY = "WQS_EMAIL_ALIYUN_ACCESS_KEY_ID";
    private static final String WQS_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY = "WQS_EMAIL_ALIYUN_ACCESS_KEY_SECRET";
    private static final String WQS_EMAIL_ALIYUN_FROM_KEY = "WQS_EMAIL_ALIYUN_FROM";
    ...
    private static void initClient() {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(WQS_EMAIL_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(WQS_EMAIL_ALIYUN_ACCESS_KEY_SECRET_KEY);
    ...
    public static String getDefaultFrom() {
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        String signName = devConfigApi.getValueByKey(WQS_EMAIL_ALIYUN_FROM_KEY);
