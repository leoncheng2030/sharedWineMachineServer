 ...
 */
package vip.wqs.dev.modular.config.service.impl;
...
import vip.wqs.dev.modular.config.entity.DevConfig;
import vip.wqs.dev.modular.config.enums.DevConfigCategoryEnum;
import vip.wqs.dev.modular.config.mapper.DevConfigMapper;
import vip.wqs.dev.modular.config.param.*;
...
public class DevConfigServiceImpl extends ServiceImpl<DevConfigMapper, DevConfig> implements DevConfigService {
    ...
    /** 缓存前缀 */
    private static final String CONFIG_CACHE_KEY = "dev-record:";
    ...
    public List<DevConfig> sysBaseList() {
        ...
        // 或key为特殊的几个
        lambdaQueryWrapper.or().in(DevConfig::getConfigKey, CollectionUtil.newArrayList(WQS_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_B_KEY,
                WQS_SYS_DEFAULT_ALLOW_REGISTER_FLAG_FOR_C_KEY,
                WQS_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_B_KEY,
                WQS_SYS_DEFAULT_ALLOW_PHONE_LOGIN_FLAG_FOR_C_KEY,
                WQS_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_B_KEY,
                WQS_SYS_DEFAULT_ALLOW_EMAIL_LOGIN_FLAG_FOR_C_KEY));
