 ...
 */
package vip.wqs.dev.modular.push.util;
...
public class DevPushDingTalkUtil {
    ...
    private static final String WQS_PUSH_DINGTALK_SIGN_KEY = "WQS_PUSH_DINGTALK_SIGN";
    private static final String WQS_PUSH_DINGTALK_TOKEN_ID_KEY = "WQS_PUSH_DINGTALK_TOKEN_ID";
    ...
    private static void initClient() {
        ...
        /* sign */
        String sign = devConfigApi.getValueByKey(WQS_PUSH_DINGTALK_SIGN_KEY);
        ...
        /* tokenId */
        String tokenId = devConfigApi.getValueByKey(WQS_PUSH_DINGTALK_TOKEN_ID_KEY);
