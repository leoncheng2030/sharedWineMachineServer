...
public class DevSmsAliyunUtil {
    ...
    private static final String WQS_SMS_ALIYUN_ACCESS_KEY_ID_KEY = "WQS_SMS_ALIYUN_ACCESS_KEY_ID";
    private static final String WQS_SMS_ALIYUN_ACCESS_KEY_SECRET_KEY = "WQS_SMS_ALIYUN_ACCESS_KEY_SECRET";
    private static final String WQS_SMS_ALIYUN_DEFAULT_SIGN_NAME_KEY = "WQS_SMS_ALIYUN_DEFAULT_SIGN_NAME";
    ...
    private static void initClient(String signName) {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(WQS_SMS_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(WQS_SMS_ALIYUN_ACCESS_KEY_SECRET_KEY);
    ...
    public static String getDefaultSignName() {
        // 签名为空，则获取默认签名
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        String signName = devConfigApi.getValueByKey(WQS_SMS_ALIYUN_DEFAULT_SIGN_NAME_KEY);
        if(ObjectUtil.isEmpty(signName)) {
