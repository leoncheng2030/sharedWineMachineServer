 ...
 */
package vip.wqs.dev.modular.sms.util;
...
public class DevSmsXiaonuoUtil {
    ...
    private static final String WQS_SMS_XIAONUO_ACCESS_KEY_ID_KEY = "WQS_SMS_XIAONUO_ACCESS_KEY_ID";
    private static final String WQS_SMS_XIAONUO_ACCESS_KEY_SECRET_KEY = "WQS_SMS_XIAONUO_ACCESS_KEY_SECRET";
    private static final String WQS_SMS_XIAONUO_REQUEST_URL_KEY = "WQS_SMS_XIAONUO_REQUEST_URL";
    private static final String WQS_SMS_XIAONUO_DEFAULT_SIGN_NAME_KEY = "WQS_SMS_XIAONUO_DEFAULT_SIGN_NAME";
    ...
    private static void initClient(String signName) {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(WQS_SMS_XIAONUO_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(WQS_SMS_XIAONUO_ACCESS_KEY_SECRET_KEY);
        ...
        /* requestUrl */
        String requestUrl = devConfigApi.getValueByKey(WQS_SMS_XIAONUO_REQUEST_URL_KEY);
    ...
    public static String getDefaultSignName() {
        // 签名为空，则获取默认签名
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        String signName = devConfigApi.getValueByKey(WQS_SMS_XIAONUO_DEFAULT_SIGN_NAME_KEY);
        if(ObjectUtil.isEmpty(signName)) {
