 ...
 */
package vip.wqs.dev.modular.message.service.impl;
...
import vip.wqs.dev.modular.message.entity.DevMessage;
import vip.wqs.dev.modular.message.enums.DevMessageCategoryEnum;
import vip.wqs.dev.modular.message.mapper.DevMessageMapper;
import vip.wqs.dev.modular.message.param.DevMessageIdParam;
import vip.wqs.dev.modular.message.param.DevMessageListParam;
import vip.wqs.dev.modular.message.param.DevMessagePageParam;
import vip.wqs.dev.modular.message.param.DevMessageSendParam;
import vip.wqs.dev.modular.message.result.DevMessageResult;
import vip.wqs.dev.modular.message.service.DevMessageService;
import vip.wqs.dev.modular.relation.entity.DevRelation;
import vip.wqs.dev.modular.relation.enums.DevRelationCategoryEnum;
import vip.wqs.dev.modular.relation.service.DevRelationService;
