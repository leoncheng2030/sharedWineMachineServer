...
public class DevSmsTencentUtil {
    ...
    private static final String WQS_SMS_TENCENT_SECRET_ID_KEY = "WQS_SMS_TENCENT_SECRET_ID";
    private static final String WQS_SMS_TENCENT_SECRET_KEY_KEY = "WQS_SMS_TENCENT_SECRET_KEY";
    private static final String WQS_SMS_TENCENT_DEFAULT_SDK_APP_ID_KEY = "WQS_SMS_TENCENT_DEFAULT_SDK_APP_ID";
    private static final String WQS_SMS_TENCENT_DEFAULT_SIGN_NAME_KEY = "WQS_SMS_TENCENT_DEFAULT_SIGN_NAME";
    ...
    private static void initClient(String signName) {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(WQS_SMS_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(WQS_SMS_TENCENT_SECRET_KEY_KEY);
        ...
        /* sdkAppId */
        String sdkAppId = devConfigApi.getValueByKey(WQS_SMS_TENCENT_DEFAULT_SDK_APP_ID_KEY);
    ...
    public static String getDefaultSignName() {
        // 签名为空，则获取默认签名
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        String signName = devConfigApi.getValueByKey(WQS_SMS_TENCENT_DEFAULT_SIGN_NAME_KEY);
        if(ObjectUtil.isEmpty(signName)) {
