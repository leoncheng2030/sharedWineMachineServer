 ...
 */
package vip.wqs.dev.modular.email.service.impl;
...
import vip.wqs.dev.modular.email.entity.DevEmail;
import vip.wqs.dev.modular.email.enums.DevEmailEngineTypeEnum;
import vip.wqs.dev.modular.email.mapper.DevEmailMapper;
import vip.wqs.dev.modular.email.param.*;
import vip.wqs.dev.modular.email.service.DevEmailService;
import vip.wqs.dev.modular.email.util.DevEmailAliyunUtil;
import vip.wqs.dev.modular.email.util.DevEmailLocalUtil;
import vip.wqs.dev.modular.email.util.DevEmailTencentUtil;
...
public class DevEmailServiceImpl extends ServiceImpl<DevEmailMapper, DevEmail> implements DevEmailService {
    ...
    /** 默认邮件引擎 */
    private static final String WQS_SYS_DEFAULT_EMAIL_ENGINE_KEY = "WQS_SYS_DEFAULT_EMAIL_ENGINE";
    ...
    public void sendDynamicTxt(DevEmailSendDynamicTxtParam devEmailSendDynamicTxtParam) {
        String defaultEmailEngine = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_EMAIL_ENGINE_KEY);
