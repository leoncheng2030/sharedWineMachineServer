 ...
 */
package vip.wqs.dev.modular.push.service.impl;
...
import vip.wqs.dev.modular.push.entity.DevPush;
import vip.wqs.dev.modular.push.enums.DevPushEngineTypeEnum;
import vip.wqs.dev.modular.push.enums.DevPushMessageTypeEnum;
import vip.wqs.dev.modular.push.enums.DevPushNoticeTypeEnum;
import vip.wqs.dev.modular.push.mapper.DevPushMapper;
import vip.wqs.dev.modular.push.param.*;
import vip.wqs.dev.modular.push.service.DevPushService;
import vip.wqs.dev.modular.push.util.DevPushDingTalkUtil;
import vip.wqs.dev.modular.push.util.DevPushFeiShuUtil;
import vip.wqs.dev.modular.push.util.DevPushWorkWechatUtil;
...
public class DevPushServiceImpl extends ServiceImpl<DevPushMapper, DevPush> implements DevPushService {
    ...
    /** 默认消息引擎 */
    private static final String WQS_SYS_DEFAULT_PUSH_ENGINE_KEY = "WQS_SYS_DEFAULT_PUSH_ENGINE";
    ...
    public void pushDynamicText(DevPushDynamicTextParam devPushDynamicTextParam) {
        String defaultEmailEngine = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PUSH_ENGINE_KEY);
