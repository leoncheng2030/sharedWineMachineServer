...
public class DevPushWorkWechatUtil {
    ...
    private static final String WQS_PUSH_WORKWECHAT_TOKEN_ID_KEY = "WQS_PUSH_WORKWECHAT_TOKEN_ID";
    ...
    private static void initClient() {
        ...
        /* tokenId */
        String tokenId = devConfigApi.getValueByKey(WQS_PUSH_WORKWECHAT_TOKEN_ID_KEY);
