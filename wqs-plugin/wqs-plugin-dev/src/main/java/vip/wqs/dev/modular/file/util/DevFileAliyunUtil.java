...
public class DevFileAliyunUtil {
    ...
    private static final String WQS_FILE_ALIYUN_ACCESS_KEY_ID_KEY = "WQS_FILE_ALIYUN_ACCESS_KEY_ID";
    private static final String WQS_FILE_ALIYUN_ACCESS_KEY_SECRET_KEY = "WQS_FILE_ALIYUN_ACCESS_KEY_SECRET";
    private static final String WQS_FILE_ALIYUN_END_POINT_KEY = "WQS_FILE_ALIYUN_END_POINT";
    private static final String WQS_FILE_ALIYUN_DEFAULT_BUCKET_NAME = "WQS_FILE_ALIYUN_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* accessKeyId */
        String accessKeyId = devConfigApi.getValueByKey(WQS_FILE_ALIYUN_ACCESS_KEY_ID_KEY);
        ...
        /* accessKeySecret */
        String accessKeySecret = devConfigApi.getValueByKey(WQS_FILE_ALIYUN_ACCESS_KEY_SECRET_KEY);
        ...
        /* endpoint */
        String endpoint = devConfigApi.getValueByKey(WQS_FILE_ALIYUN_END_POINT_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(WQS_FILE_ALIYUN_DEFAULT_BUCKET_NAME);
