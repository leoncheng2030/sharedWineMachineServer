...
/**
 * 腾讯云文件工具类
 * 参考文档：<a href="https://cloud.tencent.com/document/product/436/10199">参考文档</a>
 *
 * @author xuyuxiang
 * @date 2022/1/2 18:13
 */
...
public class DevFileTencentUtil {
    ...
    private static final String WQS_FILE_TENCENT_SECRET_ID_KEY = "WQS_FILE_TENCENT_SECRET_ID";
    private static final String WQS_FILE_TENCENT_SECRET_KEY_KEY = "WQS_FILE_TENCENT_SECRET_KEY";
    private static final String WQS_FILE_TENCENT_REGION_ID_KEY = "WQS_FILE_TENCENT_REGION_ID";
    private static final String WQS_FILE_TENCENT_DEFAULT_BUCKET_NAME = "WQS_FILE_TENCENT_DEFAULT_BUCKET_NAME";
    ...
    private static void initClient() {
        ...
        /* secretId */
        String secretId = devConfigApi.getValueByKey(WQS_FILE_TENCENT_SECRET_ID_KEY);
        ...
        /* secretKey */
        String secretKey = devConfigApi.getValueByKey(WQS_FILE_TENCENT_SECRET_KEY_KEY);
        ...
        /* regionId */
        String regionId = devConfigApi.getValueByKey(WQS_FILE_TENCENT_REGION_ID_KEY);
        ...
        /* 默认BucketName */
        defaultBucketName = devConfigApi.getValueByKey(WQS_FILE_TENCENT_DEFAULT_BUCKET_NAME);
