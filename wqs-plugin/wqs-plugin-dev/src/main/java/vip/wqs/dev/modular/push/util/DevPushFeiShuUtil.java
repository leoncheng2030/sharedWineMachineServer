...
public class DevPushFeiShuUtil {
    ...
    private static final String WQS_PUSH_FEISHU_TOKEN_ID_KEY = "WQS_PUSH_FEISHU_TOKEN_ID";
    ...
    private static void initClient() {
        ...
        /* tokenId */
        String tokenId = devConfigApi.getValueByKey(WQS_PUSH_FEISHU_TOKEN_ID_KEY);
