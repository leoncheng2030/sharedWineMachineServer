 ...
 */
package vip.wqs.client.core.util;
...
import vip.wqs.client.core.enums.ClientPasswordComplexityEnum;
...
public class ClientPasswordUtl {
    ...
    /** C端系统默认密码 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_FOR_C";

    /** C端系统密码修改验证方式 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_UPDATE_VALID_TYPE_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_UPDATE_VALID_TYPE_FOR_C";

    /** C端密码最小长度 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_MIN_LENGTH_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_MIN_LENGTH_FOR_C";

    /** C端密码最大长度 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_MAX_LENGTH_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_MAX_LENGTH_FOR_C";

    /** C端密码复杂度 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_COMPLEXITY_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_COMPLEXITY_FOR_C";

    /** C端密码不能连续存在相同字符个数 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_CONTINUOUS_SAME_CHARACTER_LENGTH_FOR_C_KEY= "WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_CONTINUOUS_SAME_CHARACTER_LENGTH_FOR_C";

    /** C端密码不能包含用户信息开关（开启后，密码中将不能包含账号、手机号、邮箱前缀和姓名拼音） */
    private static final String WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_CONTAINS_USER_INFO_FLAG_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_CONTAINS_USER_INFO_FLAG_FOR_C";

    /** C端密码不能使用历史密码开关 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_HISTORY_FLAG_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_HISTORY_FLAG_FOR_C";

    /** C端密码不能使用历史密码范围个数 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_HISTORY_COUNT_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_HISTORY_COUNT_FOR_C";

    /** C端密码不能使用弱密码库中密码开关 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_WEAK_FLAG_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_WEAK_FLAG_FOR_C";

    /** C端密码自定义额外弱密码库 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_DEFINE_WEAK_DATABASE_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_DEFINE_WEAK_DATABASE_FOR_C";

    /** C端密码有效期天数 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_EXPIRED_DAYS_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_EXPIRED_DAYS_FOR_C";

    /** C端密码过期前提醒天数 */
    private static final String WQS_SYS_DEFAULT_PASSWORD_EXPIRED_NOTICE_DAYS_FOR_C_KEY = "WQS_SYS_DEFAULT_PASSWORD_EXPIRED_NOTICE_DAYS_FOR_C";
    ...
    public static String getDefaultPassword() {
        ...
        String defaultPassword = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_FOR_C_KEY);
    ...
    public static void validUpdatePasswordValidType(String type) {
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        String passwordUpdateValidType = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_UPDATE_VALID_TYPE_FOR_C_KEY);
    ...
    public static void validNewPassword(String newPassword) {
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        // 密码最小长度
        String passwordMinLength = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_MIN_LENGTH_FOR_C_KEY);
        ...
        // 密码最大长度
        String passwordMaxLength = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_MAX_LENGTH_FOR_C_KEY);
        ...
        // 密码复杂度
        String passwordComplexity = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_COMPLEXITY_FOR_C_KEY);
        ...
        // 密码不能连续存在相同字符个数
        String passwordNotAllowContinuousSameCharacterLength = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_CONTINUOUS_SAME_CHARACTER_LENGTH_FOR_C_KEY);
        ...
        // 密码不能使用弱密码库中密码开关
        String passwordNotAllowUseWeakFlag = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_WEAK_FLAG_FOR_C_KEY);
        if(ObjectUtil.isNotEmpty(passwordNotAllowUseWeakFlag)){
            if(Convert.toBool(passwordNotAllowUseWeakFlag)){
                ...
                // 获取自定义额外弱密码库
                String passwordDefineWeakDatabase = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_DEFINE_WEAK_DATABASE_FOR_C_KEY);
    ...
    public static void validNewPassword(String userId, String account, String name, String phone, String email, String newPassword) {
        DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
        // 密码不能包含用户信息开关
        String passwordNotAllowContainsUserInfoFlag = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_CONTAINS_USER_INFO_FLAG_FOR_C_KEY);
        ...
        // 密码不能使用历史密码开关
        String passwordNotAllowUseHistoryFlag = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_HISTORY_FLAG_FOR_C_KEY);
        if(ObjectUtil.isNotEmpty(passwordNotAllowUseHistoryFlag)){
            if(Convert.toBool(passwordNotAllowUseHistoryFlag)){
                // 密码不能使用历史密码范围个数
                String passwordNotAllowContainsHistoryCount = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_NOT_ALLOW_USE_HISTORY_COUNT_FOR_C_KEY);
    ...
    public static boolean isUserPasswordExpired(String userId) {
        ...
        if(ObjectUtil.isEmpty(clientUserExt)){
            ...
            DevConfigApi devConfigApi = SpringUtil.getBean(DevConfigApi.class);
            // 获取密码有效期天数
            String passwordExpiredDays = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_EXPIRED_DAYS_FOR_C_KEY);
    ...
    public static List<ClientUser> thisDayPasswordExpiredNeedNoticeUserIdList() {
        ...
        if(ObjectUtil.isNotEmpty(passwordExpiredDays)){
            // 获取密码过期前提醒天数
            String passwordExpiredNoticeDays = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_PASSWORD_EXPIRED_NOTICE_DAYS_FOR_C_KEY);
            // 密码过期前提醒天数如果不为空
            if(ObjectUtil.isNotEmpty(passwordExpiredDays)){
                // 获取密码修改日期距离提醒日的天数N
