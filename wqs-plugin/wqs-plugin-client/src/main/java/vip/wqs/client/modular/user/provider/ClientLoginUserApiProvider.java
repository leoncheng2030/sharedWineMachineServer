 ...
 */
package vip.wqs.client.modular.user.provider;
...
public class ClientLoginUserApiProvider implements SaBaseLoginUserApi {
    ...
    @Override
    public SaBaseClientLoginUser getClientUserByWechatOpenid(String openid) {
        return clientUserService.getUserByWechatOpenid(openid);
    }

    @Override
    public void bindWechatInfo(String userId, String openid, String unionid, String nickname, String avatarUrl) {
        clientUserService.bindWechatInfo(userId, openid, unionid, nickname, avatarUrl);
    }

    @Override
    public String createWechatUser(String account, String nickname, String avatarUrl, String openid, String unionid, String phone) {
        return clientUserService.createWechatUser(account, nickname, avatarUrl, openid, unionid, phone);
    }
}
