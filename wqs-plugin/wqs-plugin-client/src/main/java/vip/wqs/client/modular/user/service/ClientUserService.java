...
public interface ClientUserService extends IService<ClientUser> {
     ...
     */
    Page<ClientUser> selector(ClientUserPageParam clientUserPageParam);
     ...
     * @date 2025/01/01 10:00
     */
    List<ClientUser> listByIdList(List<String> idList);

    /**
     * 根据微信openid获取用户信息，查不到则返回null
     *
     ...
     * @date 2025/01/29
     */
    ClientLoginUser getUserByWechatOpenid(String openid);
