 ...
 */
package vip.wqs.auth.modular.third.service.impl;
...
import vip.wqs.auth.modular.third.entity.AuthThirdUser;
import vip.wqs.auth.modular.third.enums.AuthThirdPlatformEnum;
import vip.wqs.auth.modular.third.mapper.AuthThirdMapper;
import vip.wqs.auth.modular.third.param.AuthThirdCallbackParam;
import vip.wqs.auth.modular.third.param.AuthThirdRenderParam;
import vip.wqs.auth.modular.third.param.AuthThirdUserPageParam;
import vip.wqs.auth.modular.third.result.AuthThirdRenderResult;
import vip.wqs.auth.modular.third.service.AuthThirdService;
...
public class AuthThirdServiceImpl extends ServiceImpl<AuthThirdMapper, AuthThirdUser> implements AuthThirdService {
    ...
    private static final String WQS_THIRD_GITEE_CLIENT_ID_KEY = "WQS_THIRD_GITEE_CLIENT_ID";
    private static final String WQS_THIRD_GITEE_CLIENT_SECRET_KEY = "WQS_THIRD_GITEE_CLIENT_SECRET";
    private static final String WQS_THIRD_GITEE_REDIRECT_URL_KEY = "WQS_THIRD_GITEE_REDIRECT_URL";

    private static final String WQS_THIRD_WECHAT_CLIENT_ID_KEY = "WQS_THIRD_WECHAT_CLIENT_ID";
    private static final String WQS_THIRD_WECHAT_CLIENT_SECRET_KEY = "WQS_THIRD_WECHAT_CLIENT_SECRET";
    private static final String WQS_THIRD_WECHAT_REDIRECT_URL_KEY = "WQS_THIRD_WECHAT_REDIRECT_URL";
    ...
    private AuthRequest getAuthRequest(String source) {
        ...
        if (source.equals(AuthThirdPlatformEnum.GITEE.getValue())) {
            ...
            authRequest = new AuthGiteeRequest(AuthConfig.builder()
                    .clientId(devConfigApi.getValueByKey(WQS_THIRD_GITEE_CLIENT_ID_KEY))
                    .clientSecret(devConfigApi.getValueByKey(WQS_THIRD_GITEE_CLIENT_SECRET_KEY))
                    .redirectUri(devConfigApi.getValueByKey(WQS_THIRD_GITEE_REDIRECT_URL_KEY))
                    .build());
        }
        if(source.equals(AuthThirdPlatformEnum.WECHAT.getValue())){
            // 微信登录
            authRequest = new AuthWeChatOpenRequest(AuthConfig.builder()
                    .clientId(devConfigApi.getValueByKey(WQS_THIRD_WECHAT_CLIENT_ID_KEY))
                    .clientSecret(devConfigApi.getValueByKey(WQS_THIRD_WECHAT_CLIENT_SECRET_KEY))
                    .redirectUri(devConfigApi.getValueByKey(WQS_THIRD_WECHAT_REDIRECT_URL_KEY))
                    .build());
        }
        return authRequest;
    }
