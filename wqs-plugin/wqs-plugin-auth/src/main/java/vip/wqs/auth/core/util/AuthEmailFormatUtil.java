 ...
 */
package vip.wqs.auth.core.util;
 ...
 **/
public class AuthEmailFormatUtil {

    /** 系统名称 */
    private static final String WQS_SYS_NAME_KEY = "WQS_SYS_NAME";
    ...
    public static String format(String content, JSONObject paramMap) {
        ...
        // 获取系统名称
        String sysName = devConfigApi.getValueByKey(WQS_SYS_NAME_KEY);
        // 系统名称
