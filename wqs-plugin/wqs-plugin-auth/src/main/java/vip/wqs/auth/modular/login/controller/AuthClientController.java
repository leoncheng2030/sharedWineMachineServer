 ...
 */
package vip.wqs.auth.modular.login.controller;
...
public class AuthClientController {
    ...
    @Operation(summary = "C端小程序登录")
    @PostMapping("/auth/c/doLoginByMini")
    public CommonResult<String> doLoginByMini(@RequestBody @Valid AuthMiniLoginParam authMiniLoginParam) {
        return CommonResult.data(authService.doLoginByMini(authMiniLoginParam, SaClientTypeEnum.C.getValue()));
    }
}
