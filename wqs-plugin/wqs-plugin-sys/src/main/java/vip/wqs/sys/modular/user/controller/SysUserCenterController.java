 ...
 */
package vip.wqs.sys.modular.user.controller;
...
import vip.wqs.sys.modular.user.result.SysUserMessageDetailResult;
import vip.wqs.sys.modular.user.result.SysUserMessageResult;
import vip.wqs.sys.modular.user.result.SysUserPicValidCodeResult;
import vip.wqs.sys.modular.user.result.SysUserPositionResult;
 ...
 **/
@Tag(name = "B端用户个人控制器")
@ApiSupport(author = "WQS_TEAM", order = 10)
@RestController
@Validated
