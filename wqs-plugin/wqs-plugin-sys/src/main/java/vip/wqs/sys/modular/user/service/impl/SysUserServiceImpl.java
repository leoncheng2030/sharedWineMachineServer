 ...
 */
package vip.wqs.sys.modular.user.service.impl;
...
import vip.wqs.common.excel.CommonExcelCustomMergeStrategy;
import vip.wqs.common.exception.CommonException;
import vip.wqs.common.listener.CommonDataChangeEventCenter;
...
import vip.wqs.dev.api.DevMessageApi;
import vip.wqs.dev.api.DevSmsApi;
import vip.wqs.mobile.api.MobileButtonApi;
import vip.wqs.mobile.api.MobileMenuApi;
import vip.wqs.sys.core.enums.SysBuildInEnum;
import vip.wqs.sys.core.enums.SysDataTypeEnum;
import vip.wqs.sys.core.util.SysEmailFormatUtl;
import vip.wqs.sys.core.util.SysPasswordUtl;
import vip.wqs.sys.modular.group.entity.SysGroup;
...
import vip.wqs.sys.modular.position.entity.SysPosition;
import vip.wqs.sys.modular.position.service.SysPositionService;
import vip.wqs.sys.modular.relation.entity.SysRelation;
import vip.wqs.sys.modular.relation.enums.SysRelationCategoryEnum;
import vip.wqs.sys.modular.relation.service.SysRelationService;
import vip.wqs.sys.modular.resource.entity.SysButton;
import vip.wqs.sys.modular.resource.entity.SysMenu;
import vip.wqs.sys.modular.resource.entity.SysModule;
import vip.wqs.sys.modular.resource.enums.SysMenuWhetherEnum;
import vip.wqs.sys.modular.resource.enums.SysResourceCategoryEnum;
import vip.wqs.sys.modular.resource.enums.SysResourceMenuTypeEnum;
import vip.wqs.sys.modular.resource.service.SysButtonService;
import vip.wqs.sys.modular.resource.service.SysMenuService;
import vip.wqs.sys.modular.resource.service.SysModuleService;
import vip.wqs.sys.modular.role.entity.SysRole;
import vip.wqs.sys.modular.role.enums.SysRoleDataScopeCategoryEnum;
import vip.wqs.sys.modular.role.param.SysRoleGrantUserParam;
import vip.wqs.sys.modular.role.service.SysRoleService;
import vip.wqs.sys.modular.user.entity.SysUser;
import vip.wqs.sys.modular.user.entity.SysUserExt;
import vip.wqs.sys.modular.user.enums.SysUpdatePasswordValidTypeEnum;
import vip.wqs.sys.modular.user.enums.SysUserSourceFromTypeEnum;
import vip.wqs.sys.modular.user.enums.SysUserStatusEnum;
import vip.wqs.sys.modular.user.mapper.SysUserMapper;
import vip.wqs.sys.modular.user.param.*;
import vip.wqs.sys.modular.user.result.*;
import vip.wqs.sys.modular.user.service.SysUserExtService;
import vip.wqs.sys.modular.user.service.SysUserPasswordService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    /** B端重置密码验证码短信消息模板 */
    private static final String WQS_SMS_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_B_KEY = "WQS_SMS_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_B";

    /** B端重置密码验证码邮件消息模板 */
    private static final String WQS_EMAIL_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_B_KEY = "WQS_EMAIL_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_B";

    /** B端修改密码验证码短信消息模板 */
    private static final String WQS_SMS_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_B_KEY = "WQS_SMS_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_B";

    /** B端修改密码验证码邮件消息模板 */
    private static final String WQS_EMAIL_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_B_KEY = "WQS_EMAIL_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_B";

    /** B端重置密码成功短信消息模板 */
    private static final String WQS_SMS_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_B_KEY = "WQS_SMS_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_B";

    /** B端重置密码成功邮件消息模板 */
    private static final String WQS_EMAIL_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_B_KEY = "WQS_EMAIL_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_B";

    /** B端密码即将到期短信消息模板 */
    private static final String WQS_SMS_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_B_KEY = "WQS_SMS_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_B";

    /** B端密码即将到期邮件消息模板 */
    private static final String WQS_EMAIL_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_B_KEY = "WQS_EMAIL_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_B";

    /** B端绑定手机验证码短信消息模板 */
    private static final String WQS_SMS_TEMPLATE_VALID_CODE_BINDING_PHONE_FOR_B_KEY = "WQS_SMS_TEMPLATE_VALID_CODE_BINDING_PHONE_FOR_B";

    /** B端绑定邮箱验证码邮件消息模板 */
    private static final String WQS_EMAIL_TEMPLATE_VALID_CODE_BINDING_EMAIL_FOR_B_KEY = "WQS_EMAIL_TEMPLATE_VALID_CODE_BINDING_EMAIL_FOR_B";

    /** B端修改绑定手机验证码短信消息模板 */
    private static final String WQS_SMS_TEMPLATE_VALID_CODE_UPDATE_BINDING_PHONE_FOR_B_KEY = "WQS_SMS_TEMPLATE_VALID_CODE_UPDATE_BINDING_PHONE_FOR_B";

    /** B端修改绑定邮箱验证码邮件消息模板 */
    private static final String WQS_EMAIL_TEMPLATE_VALID_CODE_UPDATE_BINDING_EMAIL_FOR_B_KEY = "WQS_EMAIL_TEMPLATE_VALID_CODE_UPDATE_BINDING_EMAIL_FOR_B";

    /** B端注册账号成功短信消息模板 */
    private static final String WQS_SMS_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_B_KEY = "WQS_SMS_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_B";

    /** B端注册账号成功邮件消息模板 */
    private static final String WQS_EMAIL_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_B_KEY = "WQS_EMAIL_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_B";

    /** B端注册后是否需要绑定手机号 */
    private static final String WQS_SYS_DEFAULT_REGISTER_NEED_BIND_PHONE_FOR_B_KEY = "WQS_SYS_DEFAULT_REGISTER_NEED_BIND_PHONE_FOR_B";

    /** B端注册后是否需要绑定邮箱 */
    private static final String WQS_SYS_DEFAULT_REGISTER_NEED_BIND_EMAIL_FOR_B_KEY = "WQS_SYS_DEFAULT_REGISTER_NEED_BIND_EMAIL_FOR_B";

    /** B端新用户默认机构 */
    private static final String WQS_SYS_DEFAULT_NEW_USER_ORG_FOR_B_KEY = "WQS_SYS_DEFAULT_NEW_USER_ORG_FOR_B";

    /** B端新用户默认职位 */
    private static final String WQS_SYS_DEFAULT_NEW_USER_POSITION_FOR_B_KEY = "WQS_SYS_DEFAULT_NEW_USER_POSITION_FOR_B";

    /** B端新用户默认角色 */
    private static final String WQS_SYS_DEFAULT_NEW_USER_ROLE_FOR_B_KEY = "WQS_SYS_DEFAULT_NEW_USER_ROLE_FOR_B";

    /** 工作台默认快捷方式 */
    private static final String WQS_SYS_DEFAULT_WORKBENCH_DATA_KEY = "WQS_SYS_DEFAULT_WORKBENCH_DATA";
    ...
    public void resetPassword(SysUserIdParam sysUserIdParam) {
        ...
        if(ObjectUtil.isNotEmpty(phone)){
            // 重置密码成功短信消息模板编码
            String smsTemplateCode = devConfigApi.getValueByKey(WQS_SMS_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_B_KEY);
            // 不为空才发送
        ...
        if(ObjectUtil.isNotEmpty(email)){
            // 重置密码成功邮件消息模板内容
            String emailTemplateContent = devConfigApi.getValueByKey(WQS_EMAIL_TEMPLATE_NOTICE_PASSWORD_RESET_SUCCESS_FOR_B_KEY);
            // 不为空才发送
    ...
    public String findPasswordGetPhoneValidCode(SysUserGetPhoneValidCodeParam sysUserGetPhoneValidCodeParam) {
       return this.getPhoneValidCode(sysUserGetPhoneValidCodeParam, "重置密码验证码短信消息模板编码", WQS_SMS_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_B_KEY);
    }
    ...
    public String findPasswordGetEmailValidCode(SysUserGetEmailValidCodeParam sysUserGetEmailValidCodeParam) {
        return this.getEmailValidCode(sysUserGetEmailValidCodeParam, "重置密码验证码邮件消息模板内容", WQS_EMAIL_TEMPLATE_VALID_CODE_RESET_PASSWORD_FOR_B_KEY);
    }
    ...
    public String updatePasswordGetPhoneValidCode(SysUserGetPhoneValidCodeParam sysUserGetPhoneValidCodeParam) {
        ...
        return this.getPhoneValidCode(sysUserGetPhoneValidCodeParam, "修改密码验证码短信消息模板编码", WQS_SMS_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_B_KEY);
    }
    ...
    public String updatePasswordGetEmailValidCode(SysUserGetEmailValidCodeParam sysUserGetEmailValidCodeParam) {
        ...
        return this.getEmailValidCode(sysUserGetEmailValidCodeParam, "修改密码验证码邮件消息模板内容", WQS_EMAIL_TEMPLATE_VALID_CODE_UPDATE_PASSWORD_FOR_B_KEY);
    }
    ...
    public String bindPhoneGetPhoneValidCode(SysUserGetPhoneValidCodeParam sysUserGetPhoneValidCodeParam) {
        ...
        String phoneValidCodeReqNo = IdWorker.getIdStr();
        // 绑定手机验证码短信消息模板编码
        String smsTemplateCode = devConfigApi.getValueByKey(WQS_SMS_TEMPLATE_VALID_CODE_BINDING_PHONE_FOR_B_KEY);
        if(ObjectUtil.isEmpty(smsTemplateCode)){
    ...
    public String updateBindPhoneGetPhoneValidCode(SysUserGetPhoneValidCodeParam sysUserGetPhoneValidCodeParam) {
        ...
        String phoneValidCodeReqNo = IdWorker.getIdStr();
        // 修改绑定手机验证码短信消息模板编码
        String smsTemplateCode = devConfigApi.getValueByKey(WQS_SMS_TEMPLATE_VALID_CODE_UPDATE_BINDING_PHONE_FOR_B_KEY);
        if(ObjectUtil.isEmpty(smsTemplateCode)){
    ...
    public String bindEmailGetEmailValidCode(SysUserGetEmailValidCodeParam sysUserGetEmailValidCodeParam) {
        ...
        String emailValidCodeReqNo = IdWorker.getIdStr();
        // 绑定邮箱验证码邮件消息模板内容
        String emailTemplateContent = devConfigApi.getValueByKey(WQS_EMAIL_TEMPLATE_VALID_CODE_BINDING_EMAIL_FOR_B_KEY);
        if(ObjectUtil.isEmpty(emailTemplateContent)){
    ...
    public String updateBindEmailGetEmailValidCode(SysUserGetEmailValidCodeParam sysUserGetEmailValidCodeParam) {
        ...
        String emailValidCodeReqNo = IdWorker.getIdStr();
        // 修改绑定邮箱验证码邮件消息模板内容
        String emailTemplateContent = devConfigApi.getValueByKey(WQS_EMAIL_TEMPLATE_VALID_CODE_UPDATE_BINDING_EMAIL_FOR_B_KEY);
        if(ObjectUtil.isEmpty(emailTemplateContent)){
    ...
    public String loginWorkbench(SysUserIdParam sysUserIdParam) {
        ...
        return devConfigApi.getValueByKey(WQS_SYS_DEFAULT_WORKBENCH_DATA_KEY);
    }
    ...
    public SysUser createUserWithPhone(String phone) {
        ...
        // 发送注册成功短信
        String smsTemplateCode = devConfigApi.getValueByKey(WQS_SMS_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_B_KEY);
        // 不为空才发送
        if(ObjectUtil.isNotEmpty(smsTemplateCode)){
            // 模板内容转为JSONObject
            JSONObject contentJSONObject = JSONUtil.parseObj(smsTemplateCode);
    ...
    public SysUser createUserWithEmail(String email) {
        ...
        sysRoleService.grantUser(sysRoleGrantUserParam);
        // 发送注册成功邮件
        String emailTemplateContent = devConfigApi.getValueByKey(WQS_EMAIL_TEMPLATE_NOTICE_REGISTER_SUCCESS_FOR_B_KEY);
        // 不为空才发送
        if(ObjectUtil.isNotEmpty(emailTemplateContent)){
            // 模板内容转为JSONObject
            JSONObject contentJSONObject = JSONUtil.parseObj(emailTemplateContent);
    ...
    public Boolean isUserNeedBindPhone() {
        ...
        if(ObjectUtil.isNotEmpty(sysUserExt)){
            ...
            if(ObjectUtil.isEmpty(sysUser.getPhone())) {
                String registerNeedBindPhone = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_REGISTER_NEED_BIND_PHONE_FOR_B_KEY);
    ...
    public Boolean isUserNeedBindEmail() {
        ...
        if(ObjectUtil.isNotEmpty(sysUserExt)){
            ...
            if(ObjectUtil.isEmpty(sysUser.getEmail())) {
                String registerNeedBindEmail = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_REGISTER_NEED_BIND_EMAIL_FOR_B_KEY);
    ...
    private String getDefaultNewUserOrgId() {
        String defaultNewUserOrgId = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_NEW_USER_ORG_FOR_B_KEY);
    ...
    private String getDefaultNewUserPositionId() {
        String defaultNewUserPositionId = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_NEW_USER_POSITION_FOR_B_KEY);
    ...
    private String getDefaultNewUserRoleId() {
        String defaultNewUserRoleId = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_NEW_USER_ROLE_FOR_B_KEY);
    ...
    public void noticeUserPasswordAboutToExpired() {
        // 密码即将到期短信消息模板
        String smsTemplateCode = devConfigApi.getValueByKey(WQS_SMS_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_B_KEY);
        // 密码即将到期邮件消息模板
        String emailTemplateContent = devConfigApi.getValueByKey(WQS_EMAIL_TEMPLATE_NOTICE_PASSWORD_EXPIRED_FOR_B_KEY);
        // 获取今日需要提醒密码到期的用户集合
    ...
    private long getValidCodeExpiredDuration() {
        ...
        // 获取配置验证码失效时间
        String configCaptchaExpiredDuration = devConfigApi.getValueByKey(WQS_SYS_DEFAULT_CAPTCHA_EXPIRED_DURATION_FOR_B_KEY);
        // 判断是否为空
