...
@Getter
@Setter
@Schema(description = "酒品库存更新参数")
public class WineProductStockUpdateParam {
    ...
    /** 库存变更类型：ADD-增加，REDUCE-减少，SET-设置 */
    @Schema(description = "库存变更类型：ADD-增加，REDUCE-减少，SET-设置", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "库存变更类型不能为空")
