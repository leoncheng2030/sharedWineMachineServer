...
import vip.wqs.common.annotation.CommonNoRepeat;
import vip.wqs.common.annotation.CommonWrapper;
import vip.wqs.common.cache.CommonCacheOperator;
import vip.wqs.common.enums.CommonDeleteFlagEnum;
import vip.wqs.common.exception.CommonException;
import vip.wqs.common.interceptor.CommonTraceInterceptor;
...
import vip.wqs.common.pojo.CommonWrapperInterface;
import vip.wqs.common.util.CommonIpAddressUtil;
import vip.wqs.common.util.CommonJoinPointUtil;
import vip.wqs.common.util.CommonServletUtil;
import vip.wqs.common.util.CommonTimeFormatUtil;
import vip.wqs.core.handler.GlobalExceptionUtil;
 ...
 **/
@Configuration
@MapperScan(basePackages = { "vip.wqs.**.mapper" })
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    public static class CommonNoRepeatAop {
         ...
         */
        @Pointcut("@annotation(vip.wqs.common.annotation.CommonNoRepeat)")
                        ...
                        if (interval < commonNoRepeat.interval()) {
                            ...
                            if (secondsParam > 0) {
                                throw new CommonException(
                                        "请求过于频繁，请" + CommonTimeFormatUtil.formatSeconds(secondsParam) + "后再试");
                            }
                        }
                    }
                }
    ...
    public static class CommonWrapperAop {
         ...
         * @date 2022/9/15 21:27
         */
        @Pointcut("@annotation(vip.wqs.common.annotation.CommonWrapper)")
         ...
         */
        @SuppressWarnings("ALL")
        private Object processWrapping(ProceedingJoinPoint proceedingJoinPoint, Object originResult)
            ...
            CommonResult<Object> commonResult = (CommonResult<Object>) originResult;
         ...
         */
        @SuppressWarnings("ALL")
        private JSONObject wrapPureObject(Object originModel,
                Class<? extends CommonWrapperInterface<?>>[] baseWrapperClasses) {
