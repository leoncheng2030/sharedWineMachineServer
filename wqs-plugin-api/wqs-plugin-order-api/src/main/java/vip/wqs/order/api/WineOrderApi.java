...
public interface WineOrderApi {
     ...
     * @date 2025/01/30 16:20
     */
    WineOrderPojo getOrderById(String orderId);
     ...
     * @date 2025/01/30 16:20
     */
    WineOrderPojo getOrderByOrderNo(String orderNo);
     ...
     * @date 2025/01/30 16:20
     */
    List<WineOrderPojo> getOrdersByUserId(String userId);
     ...
     * @date 2025/01/30 16:20
     */
    List<WineOrderPojo> getOrdersByDeviceId(String deviceId);
     ...
     * @date 2025/01/30 16:20
     */
    Page<WineOrderPojo> getOrderPage(WineOrderApiPageParam param);
     ...
     * @date 2025/01/30 16:20
     */
    WineOrderStatisticsPojo getOrderStatistics(String userId);
} 